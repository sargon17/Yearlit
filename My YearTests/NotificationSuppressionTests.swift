...
struct NotificationSuppressionTests {
  @Test func binaryFulfilledOnlyWhenCompleted() async throws {
  ...
  @Test func counterFulfillmentRequiresPositiveValue() async throws {
  ...
  @Test func multipleDailyFulfillmentMatchesTargetThreshold() async throws {
  ...
  @Test func missingEntryDoesNotSuppress() async throws {
