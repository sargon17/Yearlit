...
public struct CalendarWidgetConfigurationIntent: WidgetConfigurationIntent {
  public static var title: LocalizedStringResource { "Calendar Widget" }
...
extension CalendarWidgetConfigurationIntent {
  public static var defaultCalendar: CalendarWidgetConfigurationIntent {
