...
public extension Color {
  ...
  static var brandInverted: Color {
    return contrastingShade(of: .qsOrange, fallback: .white)
  }
  ...
  static var brandSecondaryInverted: Color {
    return contrastingShade(of: .brandSecondary, fallback: .textPrimary)
  }
  ...
  static var buttonForeground: Color {
    return contrastingShade(of: .buttonBackground, fallback: .textPrimary)
  }

  private static func contrastingShade(of color: Color, fallback: Color) -> Color {
    return (try? Garnish.contrastingShade(of: color)) ?? fallback
  }
}
