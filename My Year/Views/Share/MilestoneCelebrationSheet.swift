...
struct MilestoneCelebrationSheet: View {
    ...
    private var shareMessage: String {
        ...
        switch kind {
        case .streak:
            return "I just hit \(milestone) \(unit) in a row on \(calendarName)!" + signature
        case .showedUp:
            return "I just showed up \(milestone) \(unit) on \(calendarName)!" + signature
        case .showedUpMonth:
            return "I showed up \(milestone) \(unit) this month on \(calendarName)!" + signature
        case .showedUpYear:
            return "I showed up \(milestone) \(unit) this year on \(calendarName)!" + signature
        }
    }
